...
(function() {
  ...
  (function() {
    ...
    var absoluteTime = function(s) {
      ...
      return getRest() +' &middot; ' + hour + ':' + minutes + ampm;
    };
    ...
    function Tweet(tweet) {
      ...
      var html = '<div class="twtr-tweet-wrap"> \
        ...
        <div class="twtr-tweet-text"> \
          <p> \
            <a target="_blank" href="http://twitter.com/intent/user?screen_name=' + tweet.user + '" class="t_user">' + tweet.user + '</a>: ' + tweet.tweet + ' \
			<br> <a target="_blank" class="twtr-timestamp" time="' + tweet.timestamp + '" href="http://twitter.com/' + tweet.user + '/status/' + tweet.id + '">' + tweet.created_at + '</a> \
          </p> \
        </div> \
      </div>\
	  <hr>';
